...
public class NewsArticleController {
    ...
    @PostMapping
    ResponseEntity<NewsArticleDto> createNewsArticle(@RequestBody NewsArticleDto newsArticleDto) {
        return ResponseEntity.ok(newsArticleService.create(newsArticleDto));
    }
